...
// ======================================================================
// 8. MÓDULO ÓRDENES DE COMPRA (ESTILO TARJETAS ACCESIBLES Y WHATSAPP)
// ======================================================================
...
// --- EL NUEVO BLOQUE DE ORDEN DE COMPRA Y TARJETAS GIGANTES ---
        ...
        <div class="bg-white p-4 rounded-2xl shadow-sm border-2 border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex items-center justify-between w-full sm:w-auto gap-4 pt-2 sm:pt-0 border-t sm:border-t-0 border-gray-100">
                <div class="flex items-center bg-gray-100 p-1 rounded-xl border border-gray-200">
                    <button onclick="window.modificarCantidadBoton(${idx}, -1)" class="w-12 h-12 bg-white text-red-600 rounded-lg font-black text-2xl shadow-sm flex items-center justify-center transition active:scale-90 select-none">
                        −
                    </button>
                    <span class="w-16 text-center font-black text-2xl text-gray-800 select-none">
                        ${p.pedir}
                    </span>
                    <button onclick="window.modificarCantidadBoton(${idx}, 1)" class="w-12 h-12 bg-white text-emerald-600 rounded-lg font-black text-2xl shadow-sm flex items-center justify-center transition active:scale-90 select-none">
                        +
                    </button>
                </div>
...
window.enviarOrdenWhatsApp = () => {
    ...
    if(filterPedir.length === 0) return alert("No hay productos con cantidad a pedir. Usa el botón '+' para agregar artículos.");
